...
legend('Mx','My', 'Mz')
pause(2)
saveas(gcf,'Figures/question_1_a_2d_magnetization.png')
close all
...
grid on;
pause(2)
saveas(gcf,'Figures/question_1_a_magnetization_trajectory.png')
close all
...
writerObj = VideoWriter('Videos/question_1_a.avi');
open(writerObj);
for n=1:length(M)
    M_vector = M(n, :);
    Mx = M_vector(1);
